...
{
    public class GetRefreshTokenHandler : IRequestHandler<GetRefreshTokenCommand, AuthenticationResult>
    {
        private readonly ITokenService _tokenService;
        private readonly IRefreshTokenRepository _refreshTokenRepository;
        private readonly ICurrentUserService _currentUserService;
        public GetRefreshTokenHandler(ITokenService tokenService, IRefreshTokenRepository refreshTokenRepository, ICurrentUserService currentUserService)
        {
        ...
        public async Task<AuthenticationResult> Handle(GetRefreshTokenCommand request, CancellationToken cancellationToken)
        {
